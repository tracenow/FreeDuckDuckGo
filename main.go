...
func chatWithDuckDuckGo(c *gin.Context, messages []Message, stream bool) {
...
func main() {
	...
	r.POST("/v1/chat/completions", func(c *gin.Context) {
		...
		for i := range req.Messages {
			...
			buffer.WriteString(req.Messages[i].Content)
			buffer.WriteString("\n")
		}
		// build new messages
		newMessage := Message{
		...
		chatWithDuckDuckGo(c, newMessages, req.Stream)
	})
